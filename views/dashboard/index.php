...
<div class="flex flex-col h-full bg-gray-50">
    ...
    <div class="p-4 bg-white border-t border-gray-100 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)]">
        ...
        <div class="flex items-end space-x-2">
            ...
            <div class="flex items-center space-x-1">
                <label for="image-input"
                    class="p-2 bg-gray-100 rounded-full cursor-pointer hover:bg-gray-200 transition-colors">
                ...
                <button id="audio-btn" class="p-2 bg-gray-100 rounded-full hover:bg-gray-200 transition-colors">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-gray-600" fill="none"
                        viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="flex-1 relative">
                <textarea id="user-input" rows="1"
                    class="w-full p-3 pr-12 border border-gray-200 rounded-2xl focus:ring-2 focus:ring-blue-500 outline-none transition-all resize-none h-[46px] hide-scrollbar"
        ...
        <p id="audio-status" class="hidden text-[10px] text-red-500 font-bold mt-1 animate-pulse">Gravando áudio...</p>
    </div>
</div>
